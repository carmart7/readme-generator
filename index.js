...
const questions = [
    ...
    {message: 'Choose a license!', name: 'license', type: 'list', choices: [
        {name: 'Apache 2.0 License', value: '[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)*Apache 2.0 License'},
        {name: 'BSD 3-Clause License', value: '[![License](https://img.shields.io/badge/License-BSD%203--Clause-blue.svg)](https://opensource.org/licenses/BSD-3-Clause)*BSD 3-Clause License'},
        {name: 'GNU GPL v3', value: '[![License: GPL v3](https://img.shields.io/badge/License-GPL%20v3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)*GNU GPL v3'},
        {name: 'The MIT License', value: '[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)*The MIT License'}
...
function writeToFile(fileName, data) {
    let fileText = `# ${data.title}\n`
                    ...
                    + `## Contributing\n${data.contributing}\n`
                    + `## Tests\n${data.tests}\n`
                    + `## License\n This application is covered under ${data.license.split('*')[1]}.\n`
                    + `## Questions\n`
